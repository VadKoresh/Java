...
public class Main
{
    private static final Logger searchLog = LogManager.getLogger("search");
    private static final Logger errorsLog = LogManager.getLogger("errors");
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                searchLog.info("Искали станцию - " + station);
                return station;
            }
            System.out.println("Станция не найдена :(");
            errorsLog.warn("Искали станцию - " + line);
        }
    }
